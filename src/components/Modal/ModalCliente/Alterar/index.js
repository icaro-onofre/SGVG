            ...
            {!loading && (
              <div className="flex flex-col space-y-5 h-90 mt-8 ">
                <div className="flex flex-row space-x-5">
                  <Input
                    placeholder="Nome"
                    value={selectedClienteDataFiltered[0].nome}
                    onChange={(e) => setNome(e.target.value)}
                  />
                  <Input
                    placeholder="E-mail"
                    value={selectedClienteDataFiltered[0].email}
                ...
                <div className="flex flex-row space-x-5">
                  <Input
                    placeholder="CPF"
                    value={selectedClienteDataFiltered[0].cpf}
                    onChange={(e) => setCpf(e.target.value)}
                  />
                  <Input
                    placeholder="Telefone"
                    value={selectedClienteDataFiltered[0].telefone}
